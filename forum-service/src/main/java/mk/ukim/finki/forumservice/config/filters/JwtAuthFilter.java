package mk.ukim.finki.forumservice.config.filters;

import com.auth0.jwt.exceptions.JWTVerificationException;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.auth0.jwt.interfaces.JWTVerifier;
import com.fasterxml.jackson.databind.ObjectMapper;
import mk.ukim.finki.forumservice.config.JwtAuthConstants;
import mk.ukim.finki.forumservice.model.dto.RequestDetailsDto;
...
public class JwtAuthFilter extends BasicAuthenticationFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        ...
        List<String> allowedPaths = Arrays.asList("/api/forum",
                "/api/forum/{id}", "/api/forum/for-initiative/{initiativeId}",
                "/api/forum/comments", "/api/forum/comments/for-forum/{forumId}",
                "/api/forum/comments/submitted-by", "/api/forum/comments/{id}");
