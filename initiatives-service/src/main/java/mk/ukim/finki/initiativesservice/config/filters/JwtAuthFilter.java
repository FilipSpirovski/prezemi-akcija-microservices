package mk.ukim.finki.initiativesservice.config.filters;

import com.auth0.jwt.exceptions.JWTVerificationException;
import com.auth0.jwt.interfaces.DecodedJWT;
import com.auth0.jwt.interfaces.JWTVerifier;
import com.fasterxml.jackson.databind.ObjectMapper;
import mk.ukim.finki.initiativesservice.config.JwtAuthConstants;
import mk.ukim.finki.initiativesservice.model.dto.RequestDetailsDto;
...
public class JwtAuthFilter extends BasicAuthenticationFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        ...
        List<String> allowedPaths = Arrays.asList("/api/initiatives",
                "/api/initiatives/initiated-by",
                "/api/initiatives/by-category/{category}",
                "/api/initiatives/by-type/{eventType}",
                "/api/initiatives/{id}");
